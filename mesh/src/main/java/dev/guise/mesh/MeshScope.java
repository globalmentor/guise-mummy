...
/// A scope of variables. `null` variable values are not permitted.
...
public interface MeshScope {
	...
	/// @implSpec The default implementation delegates to [#findVariable(String)].
