...
/**
 * An abstract converter that converts a {@link URI} from and to a string literal, correctly resolving relative URIs. If a base URI is provided, any URI will be
 * resolved to the given base URI. Otherwise, relative URIs are accepted as-is. For example, if relative URIs should be interpreted as path URIs, a base URI of
 * <code>path:</code> should be used.
