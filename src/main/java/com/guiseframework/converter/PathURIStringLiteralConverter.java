...
public class PathURIStringLiteralConverter extends AbstractURIStringLiteralConverter {
	...
	/**
	 * Resolves a converted URI if needed. If the URI is already absolute, no action occurs. If the URI is relative, this implementation creates a URI with the
	 * {@value URIs#PATH_SCHEME} scheme.
