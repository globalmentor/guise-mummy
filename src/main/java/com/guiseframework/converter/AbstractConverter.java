...
public abstract class AbstractConverter<V, L> extends GuiseBoundPropertyObject implements Converter<V, L> {
	...
	/**
	 * Determines whether a given literal value in the lexical space can be converted to a value in the value space. This implementation attempts to convert the
	 * literal value and returns <code>false</code> if conversion is unsuccessful.
	...
	/**
	 * Determines if the given literal in the lexical space is a valid representation of the given value in the value space. This implementation assumes that non-
	 * <code>null</code> values can correctly be compared using {@link Object#equals(Object)}.
