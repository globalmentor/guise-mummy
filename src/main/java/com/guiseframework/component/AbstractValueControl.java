...
public abstract class AbstractValueControl<V> extends AbstractControl implements ValueControl<V> {
	...
	/**
	 * Checks the state of the component for validity. This version checks the validity of the value model. This version performs no additional checks if the
	 * control is disabled.
	 ...
	 * associated value model. This version performs no additional checks if the control is disabled.
