...
/**
 * Event wizard Guise demonstration panel. Copyright © 2006-2007 GlobalMentor, Inc. Demonstrates sequence card panels, task card constraints, task status select
 * links, action card couplers, link select card couplers, and action prototypes.
