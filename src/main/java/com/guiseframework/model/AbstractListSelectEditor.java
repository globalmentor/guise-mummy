...
public abstract class AbstractListSelectEditor<V> implements ListSelectEditor<V> {
	...
	/**
	 * Commences editing a value. This method returns immediately before editing is finished. Once the value has been edited and accepted, it will be added to the
	 * list and the selected value updated to the edited value.
	 * @param value The value to edit.
	 * @param index The index at which the edited value will be placed.
	 * @param replace <code>true</code> if the value should replace the value at the given index, or <code>false</code> if the value should be inserted at the
	 *          given index.
	 */
