...
public class SelectButton extends AbstractSelectActionControl<SelectButton> implements SelectButtonControl<SelectButton>
{
	...
	*/
	public SelectButton(final GuiseSession session, final ActionModel actionModel)
	{
	...
	@exception IllegalArgumentException if the given identifier is not a valid component identifier.
	*/
	public SelectButton(final GuiseSession session, final String id, final ActionModel actionModel)
	{
