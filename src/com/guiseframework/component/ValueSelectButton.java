...
public class ValueSelectButton<V> extends AbstractSelectActionValueControl<V, ValueSelectButton<V>> implements SelectButtonControl<ValueSelectButton<V>>
{
	...
	*/
	public ValueSelectButton(final GuiseSession session, final Class<V> valueClass)
	{
	...
	*/
	public ValueSelectButton(final GuiseSession session, final ValueModel<V> model)
	{
	...
	*/
	public ValueSelectButton(final GuiseSession session, final String id, final Class<V> valueClass)
	{
	...
	@exception IllegalArgumentException if the given identifier is not a valid component identifier.
	*/
	public ValueSelectButton(final GuiseSession session, final String id, final ValueModel<V> model)
	{
