...
public class URFPropertyTableColumnModel<V extends URFResource> extends DefaultTableColumnModel<V>
{
	...
	*/
	...
	{
		this(valueClass, propertyURI, URFTURFGenerator.createReferenceString(propertyURI, new TURFNamespaceLabelManager(), null, null));	//construct the class with a label appropriate for this property URI TODO use a shared namespace label manager
	}
