...
<p>Child classes must override {@link #determineLeaf()} and {@link #determineChildNodes()}.</p>
...
//TODO comment	This implementation <code>true</code> if child nodes are not loaded and this is not a predictive dynamic tree node.
	...
	*/
	...
	This version updates the cached leaf determination if children are loaded in this method.
	...
	*/
	public DynamicTreeNodeModel(final GuiseSession session, final Class<V> valueClass)
	{
	...
	@exception NullPointerException if the given session and/or class object is <code>null</code>.
	*/
	public DynamicTreeNodeModel(final GuiseSession session, final Class<V> valueClass, final V initialValue)
	{
