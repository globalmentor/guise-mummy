...
*/
	...
	This version returns the base tree node style ID {@link #TREE_NODE_CLASS} with the given prefix/suffix, if any,
	along with styles representing the expandeded or collapseed state and whether the node is a leaf.
...
//TODO del Debug.trace("rendering tree node for", treeNode.getValue(), "is leaf", treeNode.isLeaf());	//TODO del
		...
		depictContext.writeAttribute(null, ELEMENT_IMG_ATTRIBUTE_SRC, getSession().getApplication().resolveURI(treeNodeImageURI).toString());	//src="treenode-XXX.gif"
