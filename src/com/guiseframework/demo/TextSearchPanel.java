...
public class TextSearchPanel extends DefaultNavigationPanel
{
	...
	public TextSearchPanel()
	{
		...
		message.setMessageContentType(XHTML_CONTENT_TYPE);	//indicate that the message will be of the "application/xhtml+xml" content type
		...
		final ResourceImportValidator textImportValidator=new ResourceImportValidator(new ContentType("text", "*", null), 1024*64, true);
