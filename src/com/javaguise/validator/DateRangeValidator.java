...
public class DateRangeValidator extends AbstractComparableRangeValidator<Date>
{
	...
	*/
	public DateRangeValidator(final GuiseSession session)
	{
	...
	@exception NullPointerException if the given session is <code>null</code>.
	*/
	public DateRangeValidator(final GuiseSession session, final boolean valueRequired)
	{
	...
	@exception NullPointerException if the given session is <code>null</code>.
	*/
	public DateRangeValidator(final GuiseSession session, final Date minimum, final Date maximum)
	{
		this(session, minimum, maximum, new Date(1));	//construct the class with a step of 1
	}
	...
	@exception NullPointerException if the given session is <code>null</code>.
	*/
	public DateRangeValidator(final GuiseSession session, final Date minimum, final Date maximum, final Date step)
	{
	...
	@exception NullPointerException if the given session is <code>null</code>.
	*/
	public DateRangeValidator(final GuiseSession session, final Date minimum, final Date maximum, final boolean valueRequired)
	{
	...
	@exception NullPointerException if the given session is <code>null</code>.
	*/
	public DateRangeValidator(final GuiseSession session, final Date minimum, final Date maximum, final Date step, final boolean valueRequired)
	{
