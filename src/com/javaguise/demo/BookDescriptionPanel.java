...
@see com.javaguise.component.FlyoverFrame
@see com.javaguise.geometry.CompassPoint
*/
	...
	*/
	public BookDescriptionPanel(final GuiseSession session)
	{
		...
		getModel().setLabel("Guise\u2122 Demonstration: Book Descriptions");	//set the panel title
			...
			//book panel
		final GroupPanel bookPanel=new GroupPanel(session, new FlowLayout(session, Orientation.Flow.LINE));	//create the book panel flowing horizontally
