...
public class TabsPanel extends DefaultNavigationPanel
{
	...
	*/
	public TabsPanel(final GuiseSession session)
	{
		...
		getModel().setLabel("Guise\u2122 Demonstration: Tabs");	//set the panel title	
		...
		tabbedPanelPanel.getModel().setLabel("TabbedPanel with associated CardTabControl");
				//TabbedPanel
		...
		tabbedPanelPage1Heading.getModel().setLabel("This is page 1.");	//set the text of the heading
		tabbedPanelPage1.add(tabbedPanelPage1Heading);	//add the heading to the page
		tabbedPanel.add(tabbedPanelPage1, new CardLayout.Constraints(new DefaultLabelModel(session, "Page 1")));	//add the panel with a label
					//page 2
		...
		tabbedPanelPage2Heading.getModel().setLabel("This is page 2.");	//set the text of the heading
		tabbedPanelPage2.add(tabbedPanelPage2Heading);	//add the heading to the page
		tabbedPanel.add(tabbedPanelPage2, new CardLayout.Constraints(new DefaultLabelModel(session, "Page 2")));	//add the panel with a label
		...
		tabControlPanel.getModel().setLabel("Standalone TabControl.");
				//TabControl
