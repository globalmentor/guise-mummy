...
public class ImageOpacityPanel extends DefaultNavigationPanel
{
	...
	*/
	public ImageOpacityPanel(final GuiseSession session)
	{
		...
		sliderModel.addPropertyChangeListener(ValueModel.VALUE_PROPERTY, new AbstractPropertyValueChangeListener<Float>()	//listen for value changes
				{
					public void propertyValueChange(PropertyValueChangeEvent<Float> propertyValueChangeEvent)	//if the opacity value changes
					{
