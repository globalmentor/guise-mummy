...
public class EditUserFrame extends DefaultModalFrame<DemoUser>
{
	...
	*/
	public EditUserFrame(final GuiseSession<?> session)
	{
		...
		final LayoutPanel idPanel=new LayoutPanel(session, new FlowLayout(Orientation.Flow.LINE));	//create the ID panel flowing horizontally
			//ID
		...
		final LayoutPanel namePanel=new LayoutPanel(session, new FlowLayout(Orientation.Flow.LINE));	//create the name panel flowing horizontally
			//first name
		...
		final LayoutPanel passwordPanel=new LayoutPanel(session, new FlowLayout(Orientation.Flow.LINE));	//create the password panel flowing horizontally
			//password
		...
		final LayoutPanel emailPanel=new LayoutPanel(session, new FlowLayout(Orientation.Flow.LINE));	//create the email panel flowing horizontally
			//email
