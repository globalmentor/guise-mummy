...
import com.garretwilson.guise.validator.AbstractValidator;
...
public class TextSearchFrame extends DefaultFrame
{
	...
	*/
	public TextSearchFrame(final GuiseSession<?> session)
	{
		...
		final Panel textSearchPanel=new Panel(session, new FlowLayout(Axis.X));	//create the root panel flowing horizontally
