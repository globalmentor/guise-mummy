...
public class HTTPGuiseSessionManager implements HttpSessionListener
{
	...
	/**The synchronized map of Guise applications keyed to HTTP sessions.*/
	private static final Map<HttpSession, GuiseHTTPServlet.HTTPServletGuiseApplication> guiseApplicationMap=synchronizedMap(new HashMap<HttpSession, GuiseHTTPServlet.HTTPServletGuiseApplication>());
...
*/
	...
	This implementation does nothing, as there is no way to tell with which Guise application a new Guise application should be associated.
	@param httpSessionEvent Information regarding the created HTTP session.
	@see #getGuiseSession(GuiseHTTPServlet.HTTPServletGuiseApplication, HttpServletRequest)
	*/
