...
package dev.guise.mummy.mummify.image;
...
public interface ImageMummifier extends Mummifier {
	...
	/// The configuration indicating the integer size (usually expressed as a [Long] in bytes beyond which an image should be processed.
	...
	/// aspect `_`, to be replaced using [String#format(String, Object...)].
	...
	/// `_`, to be replaced using [String#format(String, Object...)].
