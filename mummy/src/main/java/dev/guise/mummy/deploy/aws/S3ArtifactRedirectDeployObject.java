...
public class S3ArtifactRedirectDeployObject extends AbstractS3DeployObject {
	...
	///           collections (ending in a slash, e.g. `foo/bar/`) anyway.
	/// @return `true` if this redirect can only be specified properly using a routing rule.
	...
	/// {@inheritDoc}
	/// @implSpec This implementation returns the `0`, as redirect objects have no size.
	@Override
	...
	/// {@inheritDoc}
	/// @implSpec This implementation returns `"application/octet-stream"`.
	@Override
