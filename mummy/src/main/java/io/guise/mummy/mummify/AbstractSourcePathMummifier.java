...
public abstract class AbstractSourcePathMummifier extends AbstractMummifier implements SourcePathMummifier {
	...
	/// @implSpec This implementation delegates to [#getArtifactSourceDescriptionFile(MummyContext, Path)] using [Artifact#getSourcePath()].
	...
	/// @apiNote Whether a source description file is supported depends on the specific mummifier implementation.
	/// @implSpec The default implementation produces a filename based upon the source path filename with the [Mummifier#DESCRIPTION_FILE_SIDECAR_EXTENSION]
	///           added.
	/// @param context The context of static site generation.
