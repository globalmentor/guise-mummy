...
public class QuestionTreeNodeModel extends AbstractInteractionTreeNodeModel<Question> {
	...
	/**
	 * Dynamically determines whether this node is a leaf. This version determines if there is a followup evaluation with a followup interaction, or a followup
	 * interaction in a list of followups.
