 ...
 * <p>
 * If no check type is specified, the check type will automatically determined dynamically. If there is a {@link MutualExclusionPolicyModelGroup} value
 * listener, indicating that this is a mutual exclusion control, a {@link CheckType#ELLIPSE} check type will be used. Otherwise, a {@link CheckType#RECTANGLE}
 * check type will be used.
 * </p>
 * <p>
 * The default model used by a check control defaults to a value of {@link Boolean#FALSE}, as a check control does not have the capability of indicating
 * <code>null</code>.
 * </p>
 * <p>
 * A check control automatically installs a {@link ValueRequiredValidator}, as a check control does not have the capability of indicating <code>null</code>.
 * </p>
