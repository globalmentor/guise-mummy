...
/**
 * An abstract implementation of a container that is also a value control. The component valid status is updated before a change in the {@link #VALUE_PROPERTY}
 * or the {@link #VALIDATOR_PROPERTY} is fired.
 * @param <V> The type of value to represent.
 * @author Garret Wilson
 */
public abstract class AbstractContainerValueControl<V> extends AbstractContainerControl implements ValueControl<V> {
