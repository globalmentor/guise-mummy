...
/**
 * A panel displaying a navigation path as a series of breadcrumb links for the path segments. The navigation path is translated to depiction terms before being
 * displayed, so that the path segments are shown in depiction terms. This version automatically updates the breadcrumb navigation path when navigation occurs.
