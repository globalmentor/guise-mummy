...
public abstract class AbstractComponentDepictor<C extends Component> extends AbstractDepictor<C> implements ComponentDepictor<C> {
	...
	/**
	 * The listener that marks this depiction as dirty if direct children are added or removed, or <code>null</code> if the depicted component is not a container
	 * or is not installed.
	 */
	private DepictedCompositeComponentListener depictedCompositeComponentListener = null;

	/**
	 * @return The listener that marks this depiction as dirty if direct children are added or removed, or <code>null</code> if the depicted component is not a
	 *         container or is not installed.
	 */
	protected DepictedCompositeComponentListener getDepictedCompositeComponentListener() {
		return depictedCompositeComponentListener;
	}
