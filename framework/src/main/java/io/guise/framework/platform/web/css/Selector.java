...
/**
 * A selector of a CSS rule. A selector represents a list of simple selector sequences, each paired with a combinator. The first combinator of which will be
 * ignored.
