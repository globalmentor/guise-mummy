...
public abstract class AbstractInteractionTreeNodeModel<V extends Interaction> { //TODO fix extends AbstractRDFResourceTreeNodeModel<V>
	...
	/**
	 * The followup evaluation which considers this interaction a followup in this context, or <code>null</code> if there is no followup evaluation subject in
	 * this context.
	 */
	private final FollowupEvaluation followupEvaluation;

	/**
	 * @return The followup evaluation which considers this interaction a followup in this context, or <code>null</code> if there is no followup evaluation subject
	 *         in this context.
	 */
	public FollowupEvaluation getFollowupEvaluation() {
