...
public class Notification extends DefaultLabelModel {
	...
	*/
	...
	/**
	 * The options which can be expected as responses for this notification. The option ordinals represent the order in which they should be presented. Some
	 * options such as {@link Option#ABORT}, {@link Option#STOP}, and {@link Option#CANCEL}, are <dfn>fatal</dfn>, indicating that the user has actively expressed
	...
	/**
	 * Error constructor with a {@link Severity#ERROR} severity and a <code>text/plain</code> content type. If the error provides a message, it is used as the
	 * notification message; otherwise, the error's string value is used as the message.
