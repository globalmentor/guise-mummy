...
public enum View {
	...
	private static final StringTemplate LABEL_RESOURCE_KEY_TEMPLATE = StringTemplate.of("theme.view.", StringTemplate.STRING_PARAMETER, ".label");
	/** The resource key template for each view glyph. */
	private static final StringTemplate GLYPH_RESOURCE_KEY_TEMPLATE = StringTemplate.of("theme.view.", StringTemplate.STRING_PARAMETER, ".glyph");
