...
package io.guise.framework.model.urf;
...
public class URFResourceDynamicTreeNodeModel<V extends URFResource> extends AbstractURFDynamicTreeNodeModel<V> {
	...
	/**
	 * @return The URI of the URF property of which this URF resource is an object, or <code>null</code> if this resource should not be considered the object of
	 *         any property.
	 */
