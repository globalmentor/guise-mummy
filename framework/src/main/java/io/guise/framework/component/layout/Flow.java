...
public enum Flow {
	...
	public enum Direction {
		...
		/**
		 * Determines the end at which the given direction would arrive relative to this direction. For example, if this is an increasing direction and a decreasing
		 * direction is given, the decreasing direction would arrive at the near end of the flow.
