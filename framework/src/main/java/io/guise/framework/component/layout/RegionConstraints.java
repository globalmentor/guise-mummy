...
public class RegionConstraints extends AbstractConstraints {
	...
	/**
	 * Sets the alignment of a given flow. The alignment of each flow represents a bound property of type {@link Double}.
	...
	/**
	 * Sets the alignment of the line flow. For example, in a left-to-right top-to-bottom orientation, line alignments of 0.0, 0.5, and 1.0 would be equivalent to
	 * what are commonly known as <dfn>left</dfn>, <dfn>center</dfn>, and <dfn>right</dfn> alignments, respectively. This is a bound property of type
	 * {@link Double}.
	 ...
	 * what are commonly known as <dfn>top</dfn>, <dfn>middle</dfn>, and <dfn>bottom</dfn> alignments, respectively. This is a bound property of type
	 * {@link Double}.
