...
import io.guise.framework.model.urf.URFResourceDynamicTreeNodeModel;
...
public abstract class AbstractURFResourceTreeNodeRepresentationStrategy<V extends URFResource> extends TreeControl.AbstractTreeNodeRepresentationStrategy<V> {
	...
	protected boolean isResourceReferenceIncluded() {
		return resourceReferenceIncluded;
	}
	 ...
	 */
	protected void setResourceReferenceURIIncluded(final boolean referenceIncluded) {
		this.resourceReferenceIncluded = referenceIncluded;
	}
	 ...
	 */
	protected <N extends V> StringBuilder buildLabelText(final StringBuilder stringBuilder, final TreeControl treeControl, final TreeModel model,
			final TreeNodeModel<N> treeNode, final N value) { //TODO fix	protected StringBuilder buildLabelText(final StringBuilder stringBuilder, final TreeControl treeControl, final TreeModel model, final TreeNodeModel<? extends V> treeNode, final V value)	//TODO later put this method hierarchy in a custom label model
