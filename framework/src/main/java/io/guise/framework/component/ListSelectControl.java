...
public interface ListSelectControl<V> extends SelectControl<V>, ListSelectModel<V> {
	...
	/**
	 * A strategy for generating components to represent model values. The component ID should reflect a unique identifier of the item
	...
	*/
	/**
	 * Determines an identier for the given object. This value must be equal to the ID of the component returned by the
	 * {@link ComponentFactory#createComponent(VV)} method.
