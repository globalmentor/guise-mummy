/*
 * Copyright © 2000-2008 GlobalMentor, Inc. <https://www.globalmentor.com/>
 *
...
import io.guise.framework.controller.*;
import io.guise.framework.input.*;

/**
 * Abstract base class for a panel that allows progression in a sequence.
 * <p>
 * When progressing through the sequence, this panel attempts to verify the content component, if it is <code>Verifiable</code>, before changing position in the
...
public abstract class AbstractSequenceTaskPanel extends AbstractPanel {
	...
	/**
	 * @return Whether the advance buttons are distinct or dual-duty; this defaults to <code>false</code>.
	 */
	 ...
	 * @param newDistinctAdvance <code>true</code> if there should be distinct buttons for start, next, and finish, or <code>false</code> if one button should
	 ...
	 * @return <code>true</code> if the current component was verified or is not verifiable, else <code>false</code> if the current component was verifiable but
	 *         returned <code>false</code> when verified.
