 ...
 * the value stored in the model. If line wrap is not specified in the constructor, it defaults to <code>true</code>. If multiline is not specified in the
 * constructor, it defaults to <code>true</code> only when there is more than one row and line wrap is turned off. Default converters are available for the
 * following types:
 * <ul>
...
public class TextControl<V> extends AbstractTextControl<V> {
	...
	/**
	 * Sets whether the user input text is masked to prevent viewing of the literal entered value. This is a bound property of type <code>Boolean</code>.
	...
	/**
	 * Sets the maximum number of input characters to allow. This is a bound property of type <code>Integer</code>.
	...
	/**
	 * Sets whether lines will be logically wrapped in the view if needed. This is a bound property of type <code>Boolean</code>.
	...
	/**
	 * Sets whether the user is allowed to enter multiple physical lines if the control has multiple rows. This is a bound property of type <code>Boolean</code>.
