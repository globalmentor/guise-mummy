...
public class TabControl<V> extends AbstractListSelectControl<V> {
	...
	public TabControl(final ListSelectModel<V> listSelectModel, final Flow axis, final int maxTabCount) {
		this(listSelectModel, new DefaultValueRepresentationStrategy<V>(AbstractStringLiteralConverter.getInstance(listSelectModel.getValueClass())), axis,
				maxTabCount); //construct the class with a default representation strategy
	}
	...
	/**
	 * A convenience base strategy for generating components to represents model values in a list select control. The component ID should reflect a unique
	...
	*/
	...
	/**
	 * Returns a list of tabs. This method along with {@link #setTabs()} provides a <code>tabs</code> property for alternate tabs access.
	...
	*/
	...
	/**
	 * Sets the tabs in this control. This method along with {@link #getTabs()} provides a <code>tabs</code> property for alternate tabs access.
