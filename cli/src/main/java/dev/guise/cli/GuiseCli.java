...
import static dev.guise.mummy.mummify.GenericFileMummifier.DEFAULT_MEDIA_TYPES_BY_FILENAME_EXTENSION;
...
public class GuiseCli extends BaseCliApplication {
	...
	public void serve(
		...
		DEFAULT_MEDIA_TYPES_BY_FILENAME_EXTENSION.forEach((extension, mediaType) -> context.addMimeMapping(extension, mediaType.toString()));
		...
		final URI siteLocalUrl = URIs.createURI(HTTP_URI_SCHEME, null, Host.LOCALHOST.name(), port, ROOT_PATH, null, null);
