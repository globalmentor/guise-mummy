		...
		switch(longitudeCompassPoint)
		{
			case NORTH:
				switch(latitudeCompassPoint)
				{
					...
					default:
						throw new IllegalArgumentException("Latitude compass point "+latitudeCompassPoint+" must be either "+CompassPoint.WEST+" or "+CompassPoint.WEST);
				}
			case SOUTH:
				switch(latitudeCompassPoint)
				{
			...
			default:
				throw new IllegalArgumentException("Longitude compass point "+longitudeCompassPoint+" must be either "+CompassPoint.NORTH+" or "+CompassPoint.SOUTH);
		}
	}
