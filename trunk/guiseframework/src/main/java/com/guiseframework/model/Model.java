...
public interface Model extends PropertyBindable, PropertyConstrainable {
	...
	public static final ContentType PLAIN_TEXT_CONTENT_TYPE = Text.PLAIN_CONTENT_TYPE;

	/** A content type of <code>application/xhtml+xml</code>. */
	public static final ContentType XHTML_CONTENT_TYPE = XHTML.XHTML_CONTENT_TYPE;

	/** A content type of <code>application/xhtml+xml-external-parsed-entity</code>. */
	public static final ContentType XHTML_FRAGMENT_CONTENT_TYPE = XHTML.XHTML_FRAGMENT_CONTENT_TYPE;
