...
public abstract class AbstractRDFResourceTreeNodeModel<V extends RDFResource> extends DynamicTreeNodeModel<V> implements RDFObjectTreeNodeModel<V> {
	...
	public boolean isResourceChildrenIncluded() {
		return resourceChildrenIncluded;
	}

	/**
	 * Sets whether resource children are included in the node. This is a bound property of type <code>Boolean</code>.
	...
	public boolean isResourcePropertiesIncluded() {
		return resourcePropertiesIncluded;
	}

	/**
	 * Sets whether resource properties are included in the node. This is a bound property of type <code>Boolean</code>.
	...
	/**
	 * Creates a child node to represent a property object literal and optional property. This version returns an {@link RDFLiteralTreeNodeModel}.
	...
	/**
	 * Creates a child node to represent a property object resource and optional property. This version returns an {@link RDFResourceTreeNodeModel}.
	 * @param rdfProperty The property of which the object is a resource, or <code>null</code> if this object should not be considered the object of any property.
