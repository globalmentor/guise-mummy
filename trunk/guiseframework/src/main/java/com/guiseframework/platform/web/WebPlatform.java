...
public interface WebPlatform extends Platform
{
	...
	public final static ContentType GUISE_AJAX_REQUEST_CONTENT_TYPE=ContentType.getInstance(ContentType.APPLICATION_PRIMARY_TYPE, ContentType.SUBTYPE_EXTENSION_PREFIX+"guise-ajax-request"+ContentType.SUBTYPE_SUFFIX_DELIMITER_CHAR+XML_SUBTYPE_SUFFIX);

	/**The content type of a Guise AJAX response, <code>application/x-guise-ajax-response</code>.*/
	public final static ContentType GUISE_AJAX_RESPONSE_CONTENT_TYPE=ContentType.getInstance(ContentType.APPLICATION_PRIMARY_TYPE, ContentType.SUBTYPE_EXTENSION_PREFIX+"guise-ajax-response"+ContentType.SUBTYPE_SUFFIX_DELIMITER_CHAR+XML_SUBTYPE_SUFFIX);
	...
	public final static URIPath AJAX_JAVASCRIPT_PATH=GuiseApplication.GUISE_ASSETS_JAVASCRIPT_PATH.resolve("globalmentor/ajax-min.js");
	/**The path of the DOM JavaScript file, relative to the application.*/
	public final static URIPath DOM_JAVASCRIPT_PATH=GuiseApplication.GUISE_ASSETS_JAVASCRIPT_PATH.resolve("globalmentor/dom-min.js");
	/**The path of the Guise JavaScript file, relative to the application.*/
	public final static URIPath GUISE_JAVASCRIPT_PATH=GuiseApplication.GUISE_ASSETS_JAVASCRIPT_PATH.resolve("guise/guise-min.js");
	/**The path of the JavaScript JavaScript file, relative to the application.*/
	public final static URIPath JAVASCRIPT_JAVASCRIPT_PATH=GuiseApplication.GUISE_ASSETS_JAVASCRIPT_PATH.resolve("globalmentor/javascript-min.js");
