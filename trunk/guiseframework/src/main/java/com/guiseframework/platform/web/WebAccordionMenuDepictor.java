...
public class WebAccordionMenuDepictor<C extends Menu> extends AbstractWebMenuDepictor<C> { //TODO move most of this code up into a default XHTMLMenuView
	...
	/**
	 * Returns whether the component is interested in mouse events. This version returns <code>true</code>, as menus are always interested in what the mouse is
	 * doing.
	...
	*/
	...
	protected void depictBegin() throws IOException {
		...
		//TODO del Log.trace("updating accordian menu; is rollover?", component.isRollover());
