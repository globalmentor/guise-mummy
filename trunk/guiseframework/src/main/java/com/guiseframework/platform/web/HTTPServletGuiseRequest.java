...
//TODO del		public HttpServletResponse getHTTPServletResponse() {return httpServletResponse;}
	...
	private final boolean requestPathReserved;
		...
		public boolean isRequestPathReserved() {return requestPathReserved;}
	...
	private final ContentType requestContentType;
		...
		public ContentType getRequestContentType() {return requestContentType;}

	/**Whether this is an AJAX request.*/
	private final boolean ajax;

		/**@return Whether this is an AJAX request.*/
		public boolean isAJAX() {return ajax;}
...
//TODO del		this.httpServletResponse=checkInstance(response, "HTTP servlet request cannot be null.");
		...
		requestContentType=contentTypeString!=null ? ContentType.create(contentTypeString) : null;	//create a content type object from the request content type, if there is one
