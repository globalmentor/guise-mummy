...
public class AbstractCardCoupler extends GuiseBoundPropertyObject //TODO listen for the card control changing; do something to keep card couplers from leaking memory
{
	...
	public List<Component> getCards() {
		return new ArrayList<Component>(cards);
	 ...
	 * <code>true</code> unless the constraints of all connected cards implement {@link Displayable} and return <code>false</code> for
	 ...
	 * <code>true</code> unless the constraints of all connected cards implement {@link Enableable} and return <code>false</code> for
