...
Changing the editable status will recursively update the editable status of all top-level {@link EditComponent} descendant components.
Edit events of all top-level {@link EditComponent} descendant components will be repeated to all edit listeners of this component
