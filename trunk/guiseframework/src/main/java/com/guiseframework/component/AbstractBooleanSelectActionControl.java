...
public abstract class AbstractBooleanSelectActionControl extends AbstractActionValueControl<Boolean> implements SelectActionControl {
	 ...
	 * @param newAutoSelect <code>true</code> if the control should automatically set or toggle the selection state when an action occurs, or <code>false</code>
	 *          if no selection occurs automatically.
	...
	/**
	 * Sets whether the component is selected. This is a bound property of type <code>Boolean</code>. This implementation delegates to he value model.
