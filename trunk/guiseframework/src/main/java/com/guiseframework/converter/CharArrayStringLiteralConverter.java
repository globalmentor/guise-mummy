...
public class CharArrayStringLiteralConverter extends AbstractStringLiteralConverter<char[]> {
	...
	/**
	 * Converts a value from the value space to a literal value in the lexical space. This version creates a new string based upon the character array value.
	...
	/**
	 * Determines if the given literal in the lexical space is a valid representation of the given value in the value space. This implementation converts the
	 * value to a string and compares taht string with the literal value.
