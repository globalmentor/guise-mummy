...
/**
 * An object that provides prototypes. When the available prototypes change, a {@link #PROTOTYPE_PROVISIONS_PROPERTY} property change event is fired. Typically
 * provided prototypes are merged with other prototypes into menus and/or toolbars.
